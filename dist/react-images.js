...
var Lightbox = (function (_Component) {
	...
	_createClass(Lightbox, [{
		...
		value: function renderImage() {
			...
			var onClickImage = _props3.onClickImage;
			...
			return images.map(function (image, idx) {
				...
				return _react2['default'].createElement('img', {
					...
					srcSet: srcset,
					style: {
						cursor: _this.props.onClickImage ? 'pointer' : 'auto',
		...
		value: function renderThumbnails() {
			...
			var showThumbnails = _props4.showThumbnails;
			var thumbnailOffset = _props4.thumbnailOffset;
...
},{"./components/Arrow":28,"./components/Container":29,"./components/Footer":30,"./components/Header":31,"./components/PaginatedThumbnails":33,"./components/Portal":35,"./theme":41,"./utils":45,"aphrodite/no-important":6,"react-scrolllock":undefined,"react-swipeable-views":undefined}],28:[function(require,module,exports){
(function (global){
'use strict';
